<template>
  <th
    v-if="isVisible"
    class="items-center px-6 py-3 text-sm font-medium leading-4 tracking-wider text-left text-gray-700 uppercase bg-gray-200 select-none"
    :class="{ 'cursor-pointer': orderKey }"
